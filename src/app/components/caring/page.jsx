    ...
    return (
        <div>
            <div className='flex flex-col items-center mt-10 text-center'>
                <h1 className='text-xl sm:text-3xl md:text-4xl lg:text-2xl font-semibold text-[#4D4D4D] p-2'>Caring is the new marketing</h1>
                ...
                {data.map((item, i) => (
                    <div key={i} className='w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 relative flex items-center justify-center'>
                        ...
                        <div className='absolute top-2 left-0 h-full flex flex-col justify-center items-center mt-16 p-2 w-full'>
                            <div className='text-center w-48 sm:w-64 bg-[#F5F7FA] p-2 rounded-md shadow-md'>
